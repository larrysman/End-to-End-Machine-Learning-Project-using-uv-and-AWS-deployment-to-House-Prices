...
"""
FUNCTIONS TO LOAD RAW DATA, CONVERT DATE TO STANDARD DATETIME, SPLIT DATASETS INTO TRAINING, EVALUATION AND HOLDOUT.
SAVE THE SPLITTED DATASETS INTO A NEW FOLDER (../DATA/RAW).
"""
